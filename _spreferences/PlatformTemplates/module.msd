...
<solution name="com.mbeddr.cpp.__spreferences.PlatformTemplates" uuid="~_PreferencesModule#com.mbeddr.cpp.__spreferences.PlatformTemplates" moduleVersion="0" compileInMPS="true">
  <models>
